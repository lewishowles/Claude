...
**Each project must have AGENTS.md at the project root.** Copy from the project's `.codex/templates/AGENTS.md.template` or create with: purpose, functionality, tech choices, architecture notes, gotchas. AGENTS.md lives at the project root, not in `~/.codex/`.
